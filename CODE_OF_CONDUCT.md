...
MorningCoffeeSip community a harassment-free experience for everyone, regardless
...
- Giving and gracefully accepting constructive feedback. (Honest and direct is
  welcome — and is not the same as unkind.)
...
- Publishing others' private information — physical or email address, and in the
  spirit of this project, anyone's private company data — without explicit
  permission.
...
reported to the project maintainers through GitHub's private reporting channels
(see [`SECURITY.md`](SECURITY.md) for how to open a private contact). All
